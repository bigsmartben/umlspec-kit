...
| `--force`              | Flag     | Force merge/overwrite when initializing in current directory (skip confirmation)                                                                                                             || `--local`              | Flag     | Use local templates and scripts instead of downloading from GitHub (useful for local development and testing)                                                                              || `--skip-tls`           | Flag     | Skip SSL/TLS verification (not recommended)                                                                                                                                                  |
