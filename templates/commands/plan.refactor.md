...
2. **Load context**: Read FEATURE_SPEC and `/memory/constitution.md`. Ensure IMPL_PLAN uses `templates/plan-template.refactor.md` structure (replace content if needed).
